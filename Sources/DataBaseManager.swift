...
//  PerfectTemplate
//
//  Created by 许东晓 on 2018/10/30.
//

import PerfectMySQL

//MARK: 数据库信息
//let mysql_host = "182.61.40.159"
//let mysql_user = "pop"
//let mysql_password = "pop"
//let mysql_database = "pop"
////MARK: 数据库信息
let mysql_host = "182.61.40.159"
let mysql_user = "first"
let mysql_password = "123"
let mysql_database = "first"

//MARK: 表信息
let table_account = "members"                    //等级
...
open class DataBaseManager {
    ...
    func mysqlGetHomeDataResult() -> [Dictionary<String, String>]? {
        ...
        let result = selectAllDatabaseSQL(tableName: "members")
